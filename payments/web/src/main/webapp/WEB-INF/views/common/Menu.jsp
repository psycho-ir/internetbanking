                        ...
                        <table dir="rtl" border="0" cellpadding="2" cellspacing="2" width="100%">
                            ...
                            <tr valign="middle">
                                ...
                                <td align="right" nowrap="nowrap" width="95%">
                                    ...
                                    <a href="${depositCharge_url}"
                                       class="menuItem">${depositCharge_txt}</a>
                                </td>
                            </tr>
                            ...
                            <tr valign="middle">
                                ...
                                <td align="right" nowrap="nowrap" width="95%">
                                    <a href="${payLoan_url}" class="menuItem">${payLoan_txt}</a>
                                </td>
                            </tr>
                            </af:IsAppFeatureEnabled>
                            <tr valign="middle">
                                ...
                                <td align="right" nowrap="nowrap" width="95%">
                                    <a href="${tracking_url}" class="menuItem">${tracking_txt}</a>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <table dir="rtl" border="0" cellpadding="2" cellspacing="2" width="100%">
                        ...
                        <tr valign="middle">
                            ...
                            <td align="right" nowrap="nowrap" width="95%">
                                ...
                                <a href="${helpChargeDeposit_url}"
                                   class="menuItem">${helpChargeDeposit_txt}</a>
                            </td>
                        </tr>
                        </af:IsAppFeatureEnabled>
                        <af:IsAppFeatureEnabled feature="loan">
                        <tr valign="middle">
                            ...
                            <td align="right" nowrap="nowrap" width="95%">
                                <a href="${helpPayLoan_url}" class="menuItem">${helpPayLoan_txt}</a>
                            </td>
                        </tr>
                        </af:IsAppFeatureEnabled>
                        <tr valign="middle">
                            ...
                            <td align="right" nowrap="nowrap" width="95%">
                                <a href="${helpTracking_url}" class="menuItem">${helpTracing_txt}</a>
                            </td>
                        </tr>
                    </table>
                </div>
                    ...
                    <table dir="rtl" border="0" cellpadding="2" cellspacing="2" width="100%">
                        ...
                        <tr valign="middle">
                            ...
                            <td align="right" nowrap="nowrap" width="95%">
                                ...
                                <a href="${contactus_technical_url}"
