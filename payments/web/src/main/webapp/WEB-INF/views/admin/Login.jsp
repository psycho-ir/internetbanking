...
<spring:message code="admin.login.title" var="title"/>
<spring:message code="admin.login.username" var="username"/>
<spring:message code="admin.login.password" var="password"/>
<spring:message code="admin.login.blankusernameMessage" var="blankusernameMessage"/>
<spring:message code="admin.login.blankpasswordMessage" var="blankpasswordMessage"/>
<spring:message code="admin.login.incorrect" var="incorrect"/>
<spring:message code="admin.login.login" var="login"/>
<spring:message code="admin.login.enter" var="enter"/>
